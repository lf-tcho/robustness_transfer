...
from ..src.models import WideResNetForAdvRepImageNet
...
class ImageNetRepresentationAnalysis(Experiment):
    ...
    def get_model_rep(self):
        ...
        model = WideResNetForAdvRepImageNet(block=Bottleneck, layers=[3, 4, 6, 3], **kwargs)  # WideResNetForLwFImageNet
